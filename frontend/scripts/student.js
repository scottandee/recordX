...
function doDelete (id, resourceName) {
  $.ajax({
    type: 'DELETE',
    url: 'http://127.0.0.1:5000/api/v1/' + resourceName + '/' + id,
    success: () => {
      location.reload();
    }
  });
...
function doUpdate (student) {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://127.0.0.1:5000/api/v1/departments/' + student.department_id,
    success: (dept) => {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://127.0.0.1:5000/api/v1/departments/' + student.department_id + '/courses',
    success: (courses) => {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://127.0.0.1:5000/api/v1//students/' + student.id + '/courses',
    success: (stuCourses) => {
  ...
  updateFormEl.on('submit', function (event) {
    ...
    $.ajax({
      type: 'PUT',
      url: 'http://127.0.0.1:5000/api/v1/students/' + student.id,
      dataType: 'json',
...
$(document).ready(() => {
  $.ajax({
    type: 'GET',
    url: 'http://127.0.0.1:5000/api/v1/faculties',
    success: (faculties) => {
...
$(document).ready(() => {
  $('SELECT#search-dropdown.fac').on('change', () => {
    ...
    $.ajax({
      type: 'GET',
      url: 'http://127.0.0.1:5000/api/v1/faculties/' + facId + '/departments',
      success: (depts) => {
...
$(document).ready(() => {
  $('SELECT#res-filter').on('change', () => {
    ...
    $.ajax({
      type: 'GET',
      url: 'http://127.0.0.1:5000/api/v1/departments/' + deptId + '/courses',
      success: (courses) => {
...
$(document).ready(() => {
  ...
  studentForm.on('submit', (event) => {
    ...
    $.ajax({
      type: 'POST',
      url: 'http://127.0.0.1:5000/api/v1/departments/' + deptId + '/students',
      datatype: 'json',
      contentType: 'application/json',
      data: JSON.stringify(data),
      success: (data) => {
...
$(document).ready(() => {
  $.ajax({
    type: 'POST',
    url: 'http://127.0.0.1:5000/api/v1/students_search',
    datatype: 'json',
    contentType: 'application/json',
    data: JSON.stringify({}),
    success: (students) => {
