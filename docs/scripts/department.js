...
function doUpdate (dept) {
  ...
  $.ajax({
    type: 'GET',
    url: 'https://recordx-0b6779f5e001.herokuapp.com/api/v1/faculties/' + dept.faculty_id,
    success: (fac) => {
  ...
  updateFormEl.on('submit', function (event) {
    ...
    $.ajax({
      type: 'PUT',
      url: 'https://recordx-0b6779f5e001.herokuapp.com/api/v1/departments/' + dept.id,
      dataType: 'json',
...
$(document).ready(() => {
  $.ajax({
    type: 'POST',
    url: 'https://recordx-0b6779f5e001.herokuapp.com/api/v1/departments_search',
    datatype: 'json',
    contentType: 'application/json',
    data: JSON.stringify({}),
    success: (depts) => {
...
$(document).ready(() => {
  ...
  formEl.on('submit', function (event) {
    ...
    $.ajax({
      type: 'POST',
      url: 'https://recordx-0b6779f5e001.herokuapp.com/api/v1/faculties/' + facultyId + '/departments',
      datatype: 'json',
      contentType: 'application/json',
      data: JSON.stringify(data),
      success: (data) => {
